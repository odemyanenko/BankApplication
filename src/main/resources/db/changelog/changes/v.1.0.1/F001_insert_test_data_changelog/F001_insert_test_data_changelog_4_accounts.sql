DO $$
    ...
    BEGIN
        ...
        VALUES
            (GEN_RANDOM_UUID(), Client1, 'DE89370400440532013000', 3, 23000.0, 0, 0, AtDate, AtDate),
            (GEN_RANDOM_UUID(), Client2, 'DE75512108001245126199', 3, 1200.0, 0, 0, AtDate, AtDate),
            (GEN_RANDOM_UUID(), Client3, 'DE02500105170137075030', 3, 32300.0, 0, 0, AtDate, AtDate),
            (GEN_RANDOM_UUID(), Client4, 'DE02120300000000202051', 3, 10000.0, 0, 0, AtDate, AtDate),
            (GEN_RANDOM_UUID(), Client5, 'DE02100100100006820101', 3, 50000.0, 0, 0, AtDate, AtDate);
    END $$;